...
// Code credit to RyiSnow for aiding the creation of collision
// logic used in this class
// Video: https://www.youtube.com/watch?v=oPzPpUcDiYY

// Class for detecting collisions between objects
public class CollisionDetector {
    ...
    public boolean checkCollision(Object obj1, Object obj2){
        ...
        // If both objects have no bounds, no collisions will happen
        if (r1 == null || r2 == null) return false;
        // .intersects method will return true if objects overlap
    ...
    // Gets the boundary from objects
